...
var hp_json_data;
var total_events;
angular.module('kibana.HPGraph', [])
.controller('HPGraph', function($scope, eventBus, fields) {
    ...
    results.then(function(results) {
      ...
      if($scope.query_id === query_id) {
        ...
        $scope.data = $scope.data.slice(0,$scope.panel.size * $scope.panel.pages)         
         ...
         document.getElementById('text31').innerHTML="";
         document.getElementById('text32').innerHTML="";
         document.getElementById('Stage4').innerHTML="";
         document.getElementById('text42').innerHTML="";
         json_converter(hp_json_data,node_table,edge_table);
        
         //restart(); 
         //setTimeout("json_converter(test,node_table,edge_table)",5000);
