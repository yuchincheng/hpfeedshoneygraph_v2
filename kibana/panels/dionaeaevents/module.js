...
angular.module('kibana.dionaeaevents', [])
.controller('dionaeaevents', function($scope, eventBus, fields) {
    ...
    results.then(function(results) {
      ...
      if($scope.query_id === query_id) {
        ...
        $scope.data = $scope.data.slice(0,$scope.panel.size * $scope.panel.pages)         
         ...
         mal_node_table=[];
         mal_edge_table=[]; 
         document.getElementById('malgraph').innerHTML="";
         mal_json_converter(mal_data,mal_node_table,mal_edge_table);
        */
         //restart(); 
